<template>        
        ...
        <v-container grid-list-md>
            <br>
                <h1 class="headline text-uppercase " style="color: #fdd855">Proficiências e Interesses</h1>
            <br>
    ...
    data () {
        return {
            cards: [
                ...
                { 
                    title: 'Photoshop', 
                    img: require('../assets/photoshop-adobe.png'),
                ...
                { 
                    title: 'Illustrator', 
                    img: require('../assets/illustrator.png'),  
